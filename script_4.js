...
console.log(`Nombre de journalistes dans cette array: ${array.length}`);

let array_number = array.filter(function(i) {
    return i.match(/[0-9]/);
    })
console.log(`Nombre de journalistes avec un numéro dans leur pseudo: ${array_number.length}`);
console.log(array_number);

let array_aude = array.filter(function(i) {
    return i.match(`[aA]ude`);
    })
console.log(`Nombre de journalistes avec 'Aude' dans leur pseudo: ${array_aude.length}`);
...
let array_maj = array.filter(function(i) {
    return i.match(/[A-Z]/);
    })
console.log(`Nombre de handles contenant une majuscule: ${array_maj.length}`);
console.log(array_maj);

let string = array.toString()
let array_underscore = string.split("_")
console.log(`Nombre de handles contenant un underscore: ${array_underscore.length}`);


let alphabetical = array.sort()
console.log(`Par ordre alphabétique: ${alphabetical}`);

let bylength = array.sort(function(a, b){
    return a.length - b.length;
  });
  bylength = bylength.slice(0,50)
  console.log(bylength.length)
  console.log(`Les 50 plus courts: ${bylength}`);


console.log(`La position de "@epenser": ${array.indexOf("@epenser")}`);