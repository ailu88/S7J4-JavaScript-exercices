...
console.log("Le livre le plus emprunté est " + maxTitle + ". Il a été emprunté un maximum de " + maxBorrow + " fois.");
...
console.log("Le livre le moins emprunté est " + minTitle + ". Il a été emprunté un minimum de " + minBorrow + " fois.");

// 4. Trouve le livre avec l'ID: 873495
books.forEach(book=> {
 if (book["id"] == 873495 )
 console.log("Le livre correspondant à l'id 873495 s'intitule " + book["title"] + " !")
});